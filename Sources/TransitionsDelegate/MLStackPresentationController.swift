//
//  MLStackPresentationController.swift
...
class MLStackPresentationController: UIPresentationController, UIGestureRecognizerDelegate {
    ...
    private var closeButton = MLStackCloseButton()
    private var indicatorView = MLStackIndicatorView()
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        if let customHeight = self.customHeight {
            if customHeight < maxHeight {
                ...
                print("MLStackController - Custom height change to default value. Your height more maximum value")
            }
        }
...
extension MLStackPresentationController {
    ...
    func setIndicator(style: MLStackIndicatorView.Style) {
